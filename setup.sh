...
python3 -m venv venv || { echo "ERROR: Failed to create venv for spectrometer."; exit 1; }
...
python3 -m venv venv || { echo "ERROR: Failed to create venv for weather station."; exit 1; }
